...
(* CORE_GENERATION_INFO = "bnnTop,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bnnTop,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=25,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bnnTop.hwdef" *) 
module bnnTop
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.CDMA_INTROUT_1 INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.CDMA_INTROUT_1, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output cdma_introut_1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF S_AXI_LITE:M00_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN bnnTop_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.DONE INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.DONE, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output done;
  ...
  wire [255:0]activationsTop_wrapp_0_activation_in;
  wire [15:0]activationsTop_wrapp_0_activation_in_valid;
  ...
  wire [127:0]axi_bram_ctrl_2_BRAM_PORTA_DIN;
  wire [127:0]axi_bram_ctrl_2_BRAM_PORTA_DOUT;
  wire axi_bram_ctrl_2_BRAM_PORTA_EN;
  wire axi_bram_ctrl_2_BRAM_PORTA_RST;
  wire [15:0]axi_bram_ctrl_2_BRAM_PORTA_WE;
  wire [16:0]axi_bram_ctrl_3_BRAM_PORTA_ADDR;
  wire axi_bram_ctrl_3_BRAM_PORTA_CLK;
  wire [255:0]axi_bram_ctrl_3_BRAM_PORTA_DOUT;
  ...
  wire [255:0]axi_bram_ctrl_4_BRAM_PORTA_DIN;
  wire axi_bram_ctrl_4_BRAM_PORTA_EN;
  wire axi_bram_ctrl_4_BRAM_PORTA_RST;
  wire [31:0]axi_bram_ctrl_4_BRAM_PORTA_WE;
  ...
  wire [255:0]axi_cdma_1_M_AXI_RDATA;
  ...
  wire [255:0]axi_cdma_1_M_AXI_WDATA;
  wire axi_cdma_1_M_AXI_WLAST;
  wire [0:0]axi_cdma_1_M_AXI_WREADY;
  wire [31:0]axi_cdma_1_M_AXI_WSTRB;
  ...
  wire [127:0]axi_crossbar_0_M00_AXI_RDATA;
  ...
  wire [127:0]axi_crossbar_0_M00_AXI_WDATA;
  wire [0:0]axi_crossbar_0_M00_AXI_WLAST;
  wire [0:0]axi_crossbar_0_M00_AXI_WREADY;
  wire [15:0]axi_crossbar_0_M00_AXI_WSTRB;
  ...
  wire [127:0]axi_crossbar_0_M01_AXI_RDATA;
  ...
  wire [255:128]axi_crossbar_0_M01_AXI_WDATA;
  wire [1:1]axi_crossbar_0_M01_AXI_WLAST;
  wire axi_crossbar_0_M01_AXI_WREADY;
  wire [31:16]axi_crossbar_0_M01_AXI_WSTRB;
  ...
  wire [127:0]axi_crossbar_0_M02_AXI_RDATA;
  ...
  wire [383:256]axi_crossbar_0_M02_AXI_WDATA;
  wire [2:2]axi_crossbar_0_M02_AXI_WLAST;
  wire axi_crossbar_0_M02_AXI_WREADY;
  wire [47:32]axi_crossbar_0_M02_AXI_WSTRB;
  ...
  wire [255:0]axi_crossbar_2_M00_AXI_RDATA;
  ...
  wire [255:0]axi_crossbar_2_M00_AXI_WDATA;
  wire [0:0]axi_crossbar_2_M00_AXI_WLAST;
  wire axi_crossbar_2_M00_AXI_WREADY;
  wire [31:0]axi_crossbar_2_M00_AXI_WSTRB;
  ...
  wire [255:0]axi_crossbar_2_M01_AXI_RDATA;
  ...
  wire [511:256]axi_crossbar_2_M01_AXI_WDATA;
  wire [1:1]axi_crossbar_2_M01_AXI_WLAST;
  wire axi_crossbar_2_M01_AXI_WREADY;
  wire [63:32]axi_crossbar_2_M01_AXI_WSTRB;
  ...
  wire [11:0]registers_0_activations_addr_start;
  wire [7:0]registers_0_batch;
  wire registers_0_interrupt_en;
  wire [3:0]registers_0_last_col;
  wire [3:0]registers_0_last_row;
  wire [11:0]registers_0_partialsums_addr_start;
  wire registers_0_systolic_start;
  wire registers_0_weight_transfer;
  wire resetn_1;
  wire [255:0]systolic_array_wrapp_0_partialsum_out;
  wire [15:0]systolic_array_wrapp_0_partialsum_out_valid;
  ...
  assign M00_AXI_wdata[127:0] = axi_crossbar_0_M00_AXI_WDATA;
  assign M00_AXI_wlast[0] = axi_crossbar_0_M00_AXI_WLAST;
  assign M00_AXI_wstrb[15:0] = axi_crossbar_0_M00_AXI_WSTRB;
  ...
  assign axi_crossbar_0_M00_AXI_RDATA = M00_AXI_rdata[127:0];
  ...
  assign cdma_introut_0 = axi_cdma_0_cdma_introut;
  assign cdma_introut_1 = axi_cdma_1_cdma_introut;
  assign clk_1 = clk;
  assign done = partialsumsTop_wrapp_0_done;
  ...
  bnnTop_axi_bram_ctrl_0_1 axi_bram_ctrl_0
       (.bram_addr_a(axi_bram_ctrl_0_BRAM_PORTA_ADDR),
        ...
        .s_axi_aclk(clk_1),
        .s_axi_araddr(axi_crossbar_0_M01_AXI_ARADDR[44:32]),
        ...
        .s_axi_awaddr(axi_crossbar_0_M01_AXI_AWADDR[44:32]),
  ...
  bnnTop_axi_bram_ctrl_1_1 axi_bram_ctrl_1
       (.bram_addr_a(axi_bram_ctrl_1_BRAM_PORTA_ADDR),
        ...
        .s_axi_aclk(clk_1),
        .s_axi_araddr(axi_dma_0_M_AXI_MM2S_ARADDR[12:0]),
  ...
  bnnTop_axi_bram_ctrl_4_0 axi_bram_ctrl_4
       (.bram_addr_a(axi_bram_ctrl_4_BRAM_PORTA_ADDR),
        ...
        .bram_rddata_a({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b1,1'b0,1'b0,1'b0}),
  ...
  bnnTop_axi_cdma_1_0 axi_cdma_1
       (.cdma_introut(axi_cdma_1_cdma_introut),
        ...
        .s_axi_lite_aclk(clk_1),
        .s_axi_lite_araddr(axi_crossbar_1_M03_AXI_ARADDR[101:96]),
        .s_axi_lite_aresetn(resetn_1),
        .s_axi_lite_arready(axi_crossbar_1_M03_AXI_ARREADY),
        .s_axi_lite_arvalid(axi_crossbar_1_M03_AXI_ARVALID),
        .s_axi_lite_awaddr(axi_crossbar_1_M03_AXI_AWADDR[101:96]),
        .s_axi_lite_awready(axi_crossbar_1_M03_AXI_AWREADY),
        .s_axi_lite_awvalid(axi_crossbar_1_M03_AXI_AWVALID),
        .s_axi_lite_bready(axi_crossbar_1_M03_AXI_BREADY),
        .s_axi_lite_bresp(axi_crossbar_1_M03_AXI_BRESP),
        .s_axi_lite_bvalid(axi_crossbar_1_M03_AXI_BVALID),
        .s_axi_lite_rdata(axi_crossbar_1_M03_AXI_RDATA),
        .s_axi_lite_rready(axi_crossbar_1_M03_AXI_RREADY),
        .s_axi_lite_rresp(axi_crossbar_1_M03_AXI_RRESP),
        .s_axi_lite_rvalid(axi_crossbar_1_M03_AXI_RVALID),
        .s_axi_lite_wdata(axi_crossbar_1_M03_AXI_WDATA),
        .s_axi_lite_wready(axi_crossbar_1_M03_AXI_WREADY),
        .s_axi_lite_wvalid(axi_crossbar_1_M03_AXI_WVALID));
  ...
  bnnTop_systolic_array_wrapp_0_1 systolic_array_wrapp_0
       (.activation_in(activationsTop_wrapp_0_activation_in),
        .activation_in_valid(activationsTop_wrapp_0_activation_in_valid),
        .clk(clk_1),
        .last_col(registers_0_last_col),
