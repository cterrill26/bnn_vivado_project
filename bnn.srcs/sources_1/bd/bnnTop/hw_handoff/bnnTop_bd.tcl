...
proc create_root_design { parentCell } {
  ...
  set cdma_introut_1 [ create_bd_port -dir O -type intr cdma_introut_1 ]
  set clk [ create_bd_port -dir I -type clk -freq_hz 100000000 clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_LITE:M00_AXI} \
   CONFIG.ASSOCIATED_RESET {resetn} \
 ] $clk
  set done [ create_bd_port -dir O -type intr done ]
  ...
  connect_bd_intf_net -intf_net axi_crossbar_1_M02_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins axi_crossbar_1/M02_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_1_M03_AXI [get_bd_intf_pins axi_cdma_1/S_AXI_LITE] [get_bd_intf_pins axi_crossbar_1/M03_AXI]
  ...
  connect_bd_net -net axi_cdma_0_cdma_introut [get_bd_ports cdma_introut_0] [get_bd_pins axi_cdma_0/cdma_introut]
  connect_bd_net -net axi_cdma_1_cdma_introut [get_bd_ports cdma_introut_1] [get_bd_pins axi_cdma_1/cdma_introut]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_ports mm2s_introut] [get_bd_pins axi_dma_0/mm2s_introut]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins activationsTop_wrapp_0/clk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_3/s_axi_aclk] [get_bd_pins axi_bram_ctrl_4/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_cdma_1/m_axi_aclk] [get_bd_pins axi_cdma_1/s_axi_lite_aclk] [get_bd_pins axi_crossbar_0/aclk] [get_bd_pins axi_crossbar_1/aclk] [get_bd_pins axi_crossbar_2/aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins partialsumsTop_wrapp_0/clk] [get_bd_pins registers_0/clk] [get_bd_pins systolic_array_wrapp_0/clk]
  connect_bd_net -net partialsumsTop_wrapp_0_done [get_bd_ports done] [get_bd_pins partialsumsTop_wrapp_0/done]
  ...
  assign_bd_address -offset 0x40040000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x40040000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xC0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_AXI_LITE] [get_bd_addr_segs registers_0/APB_S/Reg] -force
