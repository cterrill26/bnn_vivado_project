...
vlog -work xpm  -incr -sv "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
...
vlog -work blk_mem_gen_v8_4_4  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
"../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/2985/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
...
vlog -work fifo_generator_v13_2_5  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
"../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
"../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_21  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
"../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/2ef9/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work axi_data_fifo_v2_1_20  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
"../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/47c9/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_22  -incr "+incdir+../../../../bnn.srcs/sources_1/bd/bnnTop/ipshared/ec67/hdl" \
