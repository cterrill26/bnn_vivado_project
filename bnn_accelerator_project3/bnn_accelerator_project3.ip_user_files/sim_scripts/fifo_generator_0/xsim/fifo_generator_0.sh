...
#
# Generated by Vivado on Tue Jul 27 21:29:39 -0700 2021
...
simulate()
{
  xsim fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bnnTop.protoinst" -log simulate.log
}
